...
/// ```
/// # use wit_bindgen_gen_host_wasmer_rust::dependencies::Dependencies;
/// # use wit_bindgen_core::wit_parser::{Interface, Type};
/// # use wit_bindgen_gen_host_wasmer_py::source::Source;
